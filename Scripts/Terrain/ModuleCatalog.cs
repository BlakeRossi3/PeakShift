...
public class ModuleCatalog
{
    ...
    public static ModuleCatalog BuildDefaultCatalog()
    {
        ...
        catalog.RegisterModule(new TrackModule
        {
            ...
            Difficulty = 3, Weight = 0.8f, MinDistance = 3000f
        });
        ...
        catalog.RegisterModule(new TrackModule
        {
            ...
            Difficulty = 3, Weight = 0.8f, MinDistance = 4000f,
        ...
        catalog.RegisterModule(new TrackModule
        {
            ...
            Difficulty = 5, Weight = 0.5f, MinDistance = 8000f,
        ...
        // ── Snow ramp without jump (no-gap slope change) ─────────
        catalog.RegisterModule(new TrackModule
        {
            Shape = TrackModule.ModuleShape.Ramp,
            EntryTerrain = TerrainType.Snow, ExitTerrain = TerrainType.Snow,
            Length = 250f, Rise = 100f,
            Difficulty = 1, Weight = 0.6f,
            HasJump = false
        });
        catalog.RegisterModule(new TrackModule
        {
